...
public class Dept {
    ...
    public Dept(int deptid, int deptparaid, String deptname, String deptcode, int dr, Timestamp create_time, int create_id, Timestamp update_time, int update_id, String deptParaname) {
        this.deptid = deptid;
